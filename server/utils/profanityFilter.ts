...
const SUBSTITUTION_PATTERNS = [
  ...
  {
    original: "e",
    substitutes: ["3", "€", "ë", "è", "é", "ê", "ē", "ę", "ě", "ε", "е"],
  },
  {
    original: "i",
    substitutes: ["1", "!", "|", "ï", "ì", "í", "î", "ī", "į", "ι", "і"],
  },
  {
    original: "o",
    substitutes: ["0", "∅", "ö", "ò", "ó", "ô", "õ", "ō", "ø", "ο", "о"],
  },
  {
    original: "u",
    substitutes: ["µ", "ü", "ù", "ú", "û", "ū", "ų", "υ", "у", "ս"],
  },
...
export function containsProfanity(text: string): boolean {
  ...
  const mixedCaseNormalized = originalText.replace(/[A-Z]/g, (match) =>
    match.toLowerCase(),
  );
