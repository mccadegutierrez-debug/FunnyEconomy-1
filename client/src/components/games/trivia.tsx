...
export default function Trivia() {
  ...
  const answerMutation = useMutation({
    mutationFn: async ({
      ...
      const res = await apiRequest("POST", "/api/games/trivia", {
        questionId,
        answer,
      });
      return res.json();
    ...
    <div className="space-y-6">
      <Card className="glow-primary border-primary/20">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Test your knowledge of memes and internet culture!
          </CardDescription>
        </CardHeader>
          ...
          {!currentQuestion && !gameResult ? (
            ...
            >
              <CardContent className="p-6 text-center">
                ...
                <h3
                  className={`text-2xl font-bold mb-4 ${gameResult.win ? "text-green-500" : "text-destructive"}`}
                >
                ...
                {gameResult.win && (
                  <div className="space-y-2 mb-4">
                    ...
                    <p className="text-lg font-semibold text-primary">+20 XP</p>
                  </div>
                )}
