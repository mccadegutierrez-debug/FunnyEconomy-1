...
export default function Crash() {
  ...
  const playMutation = useMutation({
    mutationFn: async ({
      ...
      const res = await apiRequest("POST", "/api/games/crash", {
        bet: betAmount,
        cashoutAt: cashout,
      });
      return res.json();
    ...
    <div className="space-y-6">
      <Card className="glow-accent border-accent/20">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Set your cashout multiplier - will it crash before you cash out?
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="cashout-multiplier">
                Auto Cashout at {cashoutAt.toFixed(1)}x
              </Label>
              <Slider
          ...
          <div className="space-y-4">
            ...
            <div className="text-center text-sm text-muted-foreground mb-4">
              <p>
                Potential Win: {Math.floor(bet * cashoutAt)} coins ({cashoutAt}
                x)
              </p>
            </div>
            ...
            <Button
              onClick={handlePlay}
              disabled={
                isPlaying || playMutation.isPending || !user || user.coins < bet
              }
              ...
              <CardContent className="p-6 text-center">
                ...
                <div className="space-y-2 mb-4">
                  <div className="text-lg">
                    Crashed at:{" "}
                    <span className="font-bold">{gameResult.crashPoint}x</span>
                  </div>
