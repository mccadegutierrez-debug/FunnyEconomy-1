        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
              ...
              <CardHeader className="text-center">
                <div className="flex flex-col items-center space-y-4">
                  <div className="relative">
                    <Avatar
                      className="h-24 w-24"
                      data-testid="avatar-public-profile"
                    >
                      <AvatarImage
                      ...
                      {userProfile.adminRole &&
                        userProfile.adminRole !== "none" && (
                          ...
                          >
                            ...
                            {userProfile.adminRole === "junior_admin" &&
                              "Junior Admin"}
                            {userProfile.adminRole === "admin" && "Admin"}
                            {userProfile.adminRole === "senior_admin" &&
                              "Senior Admin"}
                            {userProfile.adminRole === "lead_admin" &&
                              "Lead Admin"}
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <span data-testid="text-xp-progress">
            ...
            {userProfile.gameStats &&
              Object.keys(userProfile.gameStats).length > 0 && (
                <Card data-testid="card-game-stats">
                  ...
                  <CardContent>
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      {Object.entries(userProfile.gameStats).map(
                        ([key, value]) => (
            ...
            <Card data-testid="card-achievements">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  ...
                  <Badge
                    variant="secondary"
                    data-testid="badge-achievement-count"
                  >
              ...
              <CardContent>
                ...
                userProfile.achievements.length > 0 ? (
                      ...
                      (achievement: Achievement, index: number) => (
                        ...
                        >
                          <div className="flex-shrink-0">
                            <div
                              className={`h-10 w-10 rounded-full flex items-center justify-center ${getAchievementBadgeColor(achievement.rarity)}`}
                            >
                              ...
                              {!["star", "medal", "trophy", "crown"].includes(
                                achievement.icon,
                              ) && <Star className="h-5 w-5" />}
                            </div>
                          </div>
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2">
                              <p
                                ...
                                data-testid={`text-achievement-name-${index}`}
                              >
                                {achievement.name}
                              </p>
                              <Badge
                            ...
                            <p
                              ...
                              data-testid={`text-achievement-desc-${index}`}
                            >
                  ...
                  <div
                    ...
                    data-testid="text-no-achievements"
                  >
                  ...
                  <div>
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                      {publicInventoryItems.map((item: any, index: number) => (
                        ...
                        >
                          <div
                            className={`h-8 w-8 rounded-full mb-2 flex items-center justify-center text-white ${
                    ...
                    {userProfile.publicInventory.length > 12 && (
                      <p
                        ...
                        data-testid="text-more-items"
                      >
                        And {userProfile.publicInventory.length - 12} more
                        items...
                      </p>
                    )}
                  </div>
