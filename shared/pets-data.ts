...
export function calculateStatDecay(lastUpdate: Date | string | null | undefined, decayHours: number): number {
  // Handle null/undefined inputs by defaulting to full stats
  if (!lastUpdate) return 100;
