...
export const AVAILABLE_SKILLS: PetSkillData[] = [
  {
    ...
    name: "Sturdy",
    description:
      "Your pet won't sleep after losing a fight. Ready for round two!",
    effect: {
      type: "combat",
  ...
  },
  {
    ...
    name: "Immunized",
    description:
      "Your pet recovers from sickness 75% faster. Strong immune system!",
    effect: {
      type: "care",
  ...
  },
  {
    ...
    name: "Lucky",
    description:
      "Your pet gets 10% better rewards when hunting. Fortune favors the bold!",
    effect: {
      type: "earning",
      huntRewardBonus: 1.1,
    },
  ...
  },
  {
    ...
    name: "Breeder",
    description:
      "Your pet has a 15% higher breeding success rate. Family matters!",
    effect: {
      type: "breeding",
